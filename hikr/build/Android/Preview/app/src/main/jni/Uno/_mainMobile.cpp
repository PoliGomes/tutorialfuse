...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* hikr_hikrButton_FontSize_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* hikr_hikrButton_Text_Property_typeof();}
...
namespace g{namespace Fuse{namespace Controls{struct TextInput_type;}} namespace hikr{::g::Fuse::Controls::TextInput_type* TextBox_typeof();}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::hikr_hikrButton_FontSize_Property_typeof,
        (uType*(*)())&::g::hikr_hikrButton_Text_Property_typeof,
