...
{
    uStackFrame __("hikr_accessor_hikr_Button_Text", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("hikr_accessor_hikr_Button_Text", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
