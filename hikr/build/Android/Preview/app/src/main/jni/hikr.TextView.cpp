// This file was generated based on /Users/Poli/hikr/build/Android/Preview/cache/ux11/hikr.TextView.g.uno.
...
static void TextView_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(::g::Fuse::Controls::TextInputControl_type, interface9),
...
{
    uStackFrame __("hikr.TextView", ".ctor()");
    ctor_7();
    InitializeUX();
}
...
{
    uStackFrame __("hikr.TextView", "InitializeUX()");
