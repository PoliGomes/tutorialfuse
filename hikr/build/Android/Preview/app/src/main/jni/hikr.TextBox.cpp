// This file was generated based on /Users/Poli/hikr/build/Android/Preview/cache/ux11/hikr.TextBox.g.uno.
...
static void TextBox_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(::g::Fuse::Controls::TextInput_type, interface9),
...
::g::Fuse::Controls::TextInput_type* TextBox_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextInput_type*)uClassType::New("hikr.TextBox", options);
...
void TextBox::ctor_9()
{
    uStackFrame __("hikr.TextBox", ".ctor()");
    ctor_8();
    InitializeUX1();
}
...
{
    uStackFrame __("hikr.TextBox", "InitializeUX()");
