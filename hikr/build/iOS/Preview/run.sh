...
uninstall)
    ...
    "/usr/local/share/uno/Packages/UnoCore/1.2.2/prebuilt/iOS/bin/ios-deploy" -9 -1 "com.apps.hikr"
    exit $?
    ;;
esac
...
##else
"/usr/local/share/uno/Packages/UnoCore/1.2.2/prebuilt/iOS/bin/ios-deploy" --noninteractive --debug --bundle "build/Release-iphoneos/hikr.app" "$@"
##endif
