// This file was generated based on /Users/Poli/hikr/build/iOS/Preview/cache/ux11/hikr.Button.g.uno.
...
#include <_root.hikr_hikrButton_FontSize_Property.h>
#include <_root.hikr_hikrButton_Text_Property.h>
...
void Button::ctor_7()
{
    uStackFrame __("hikr.Button", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("hikr.Button", "set_FontSize(float)");
...
{
    uStackFrame __("hikr.Button", "InitializeUX()");
    ::g::Fuse::Reactive::This* temp1 = ::g::Fuse::Reactive::This::New1();
    ::g::hikr::Text* temp = ::g::hikr::Text::New4();
    temp_Value_inst = ::g::hikr_FuseControlsTextControl_Value_Property::New1(temp, Button::__selector0());
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::hikr_accessor_hikr_Button_Text::Singleton());
    this_Text_inst = ::g::hikr_hikrButton_Text_Property::New1(this, Button::__selector1());
    this_FontSize_inst = ::g::hikr_hikrButton_FontSize_Property::New1(this, Button::__selector2());
    ...
    temp_FontSize_inst = ::g::hikr_FuseControlsTextControl_FontSize_Property::New1(temp, Button::__selector2());
    ::g::Fuse::Reactive::Property* temp4 = ::g::Fuse::Reactive::Property::New1(temp3, ::g::hikr_accessor_hikr_Button_FontSize::Singleton());
...
{
    uStackFrame __("hikr.Button", "SetFontSize(float,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("hikr.Button", "SetText(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("hikr.Button", "set_Text(string)");
    SetText(value, NULL);
}
